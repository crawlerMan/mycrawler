...
def logmaker(bot="insta",kind=" ",description=" "):
	...
	if bot =="fb":
		...
		if os.path.exists("instaLog.txt"):
			logFile = open("instaLog.txt", "a+")
			logFile.write(log)
			logFile.close()

		else:
			with open("instaLog.txt", "w") as NewlogFile:
				NewlogFile.write(title)
				NewlogFile.write(log)
				NewlogFile.close()
    ...
    if list == None:
        for m in medias:
            ...
            try:
                ...
                logmaker(bot="insta", kind="error", description="get comments error 325")
            ...
            try:
                ...
                logmaker(bot="insta", kind="error", description="get likers error 332")
            ...
            try:
                ...
                if len(info) == 0:
                    ...
                    kafkaproducer(jsn={"collections":"instagram_users_posts","data":data},topic="instagram_bot")
                    logmaker(bot="insta", kind="log", description="instagram_users_posts send to kafka 338 ")
                    ...
                    for i in info:
                        ...
                        #i = db.instagram_users_posts.insert_one(data)
                        kafkaproducer(jsn={"collections": "instagram_users_posts", "data": data}, topic="instagram_bot")
                        logmaker(bot="insta", kind="log", description="instagram_users_posts send to kafka 361 ")
                ...
                logmaker(bot="insta", kind="error", description="get infos error 375")
        ...
        for m in medias:
            ...
            try:
                ...
                print("Somthings wrong in get comments...")
                logmaker(bot="insta", kind="error", description="get comments error 395")
            ...
            try:
                ...
                print("Somthings wrong in get likers...")
                logmaker(bot="insta", kind="error", description="get likers error 402 ")
            ...
            try:
                ...
                print("Somthings wrong in get infos...")
                logmaker(bot="insta", kind="error", description="get info error 438 ")
...
def checkout(username):
    try:
        ...
        logmaker(bot="insta", kind="error", description="database connections error 451 ")
    ...
    try:
        ...
        logmaker(bot="insta", kind="error", description="crawl error 463 ")
        pass
...
def startFunc():
    ...
    while True:
        ...
        if checkout(username):
            try:
                data={"username": username, "crawlStatus": False}
                x = db.instagram_users.insert(data)
                kafkaproducer(jsn={"collections": "instagram_users", "data": data}, topic="instagram_bot")
                logmaker(bot="insta", kind="log", description="instagram_users send to kafka 466 ")
                ...
                logmaker(bot="insta", kind="error", description="database error 484")
            break
        else:
...
def getfollowingListInfo(username,list = None):
    ...
    if list == None:
        ...
        if len(following) > 0:
            ...
            kafkaproducer(jsn={"collections": "instagram_users_list", "data": data}, topic="insta_bot")
            logmaker(bot="insta", kind="log", description="instagram_users_list send to kafka 578 ")
            ...
            for e in following:
                ...
                if t == 0:
                    ...
                    logmaker(bot="insta", kind="log", description="instagram_users_info send to kafka 594 ")
                    ...
                    if find == 0:
                        ...
                        kafkaproducer(jsn={"collections": "instagram_users", "data": data}, topic="instagram_bot")
                        logmaker(bot="insta", kind="log", description="instagram_users send to kafka 612 ")
            ...
            logmaker(bot="insta", kind="log", description="instagram_skip_list send to kafka 625 ")
        ...
        for i in list:
            ...
            for e in following:
                ...
                if t == 0:
                    ...
                    #i = db.instagram_users_info.insert_one(D)
                    kafkaproducer(jsn={"collections": "instagram_users_info", "data": D}, topic="instagram_bot")
                    logmaker(bot="insta", kind="log", description="instagram_users_info send to kafka 649 ")
                    ...
                    if find == 0:
                        ...
                        i2 = db.instagram_users.insert(data)
                        kafkaproducer(jsn={"collections": "instagram_users", "data": data}, topic="instagram_bot")
                        logmaker(bot="insta", kind="log", description="instagram_users send to kafka 667 ")
            ...
            d = {"owner": username, "following list zero": True}
            #o = db.instagram_skip_list.insert_one(d)
            kafkaproducer(jsn={"collections": "instagram_users", "data": d}, topic="instagram_bot")
            logmaker(bot="insta", kind="log", description="instagram_skip_list send to kafka 680 ")
...
def getfollowerListInfo(username,list = None):
    ...
    if list == None:
        if len(follower) > 0:
            ...
            kafkaproducer(jsn={"collections": "instagram_user_follower_userid", "data": data}, topic="insta_bot")
            logmaker(bot="insta", kind="log", description="instagram_user_follower_userid send to kafka 696 ")
            ...
            for e in follower:
                ...
                if t == 0:
                    ...
                    kafkaproducer(jsn={"collections": "instagram_users", "data": D},
                                  topic="instagram_bot")
                    logmaker(bot="insta", kind="log", description="instagram_users send to kafka 715 ")
                    ...
                    if find == 0:
                        ...
                        kafkaproducer(jsn={"collections": "instagram_users", "data": data},
                                      topic="instagram_bot")
                        logmaker(bot="insta", kind="log", description="instagram_users send to kafka 734 ")
            ...
            kafkaproducer(jsn={"collections": "instagram_skip_list", "data": d},
                          topic="insta_bot")
            logmaker(bot="insta", kind="log", description="instagram_skip_list send to kafka 748 ")
        ...
        for i in list:
            ...
            for e in follower:
                ...
                if t == 0:
                    ...
                    kafkaproducer(jsn={"collections": "instagram_users", "data": D},
                                  topic="instagram_bot")
                    logmaker(bot="insta", kind="log", description="instagram_users send to kafka 773 ")
                    print("\n")
                    print(str(g) + " - ")
                    g = g + 1
                    y = y + 1
                    ...
                    if find == 0:
                        ...
                        kafkaproducer(jsn={"collections": "instagram_users", "data": data},
                                      topic="instagram_bot")
                        logmaker(bot="insta", kind="log", description="instagram_users send to kafka 791 ")
            ...
            kafkaproducer(jsn={"collections": "instagram_skip_list", "data": d},
                          topic="insta_bot")
            logmaker(bot="insta", kind="log", description="instagram_skip_list send to kafka 805 ")
